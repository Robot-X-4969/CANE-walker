...
#define IRPIN_RIGHT A2
#define N_IR_SENSORS 2

#define DROPOFF_THRESHOLD 0.4
#define CONSECUTIVE_DROPOFF_LIMIT 10

#define IR_SWITCH_OUTPUT 50
#define IR_SWITCH_INPUT 53

#define SOUND_LEFT_LOW 40
#define SOUND_LEFT_HIGH 41
#define SOUND_RIGHT_HIGH 42
#define SOUND_RIGHT_LOW 43
#define SOUND_DROPOFF_LEFT 44
#define SOUND_DROPOFF_RIGHT 45
#define SOUND_SIGNAL_MICROS 6500

//const int vibs[] = {2, 3, 4, 5}; 
//const long vibTimeMillis = 70;

#define DIST_MIN_SIDE 5
#define DIST_MIN_MID 20
#define DIST_MIN_FRONT 25
#define DIST_MAX_SIDE 100
#define DIST_MAX_MID 125
#define DIST_MAX_FRONT 300

#define BLIPRATE_BASE 0.25
#define BLIPRATE_MAX 5.0



//global variable declarations
UltrasonicSensor usSensorLeftSide  (TRIGGER, USPIN_LEFT_SIDE);
UltrasonicSensor usSensorLeftMid   (TRIGGER, USPIN_LEFT_MID);
UltrasonicSensor usSensorLeftFront (TRIGGER, USPIN_LEFT_FRONT);
UltrasonicSensor usSensorRightFront(TRIGGER, USPIN_RIGHT_FRONT);
UltrasonicSensor usSensorRightMid  (TRIGGER, USPIN_RIGHT_MID);
UltrasonicSensor usSensorRightSide (TRIGGER, USPIN_RIGHT_SIDE);
